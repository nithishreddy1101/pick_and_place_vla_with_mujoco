...
def launch_setup(context, *args, **kwargs):
    pkg_share = FindPackageShare("panda_moveit_config")
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution([pkg_share, "config", "panda.urdf.xacro"]),
            " use_pid:=false",
            " headless:=",
    ...
    # Controller spawners
    controllers_to_spawn = ["joint_state_broadcaster", "panda_arm_controller", "hand_controller"]
